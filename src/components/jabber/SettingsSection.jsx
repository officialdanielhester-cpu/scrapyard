                    ...
                    >
                      ...
                      {item.type === "toggle" ? (
                        ...
                        <select
                          ...
                          className="rounded-md border border-border/60 bg-background px-3 py-1.5 font-mono text-xs focus:outline-none focus:border-primary"
                        >
                          {item.options.map((o) => (
